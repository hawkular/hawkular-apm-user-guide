...
=== analytics
. link:#++GET__analytics_boundendpoints__name_++[Identify the bound endpoints for a transaction]
...
NOTE: *Identify the bound endpoints for a transaction* +
...
|name|Yes|transaction name|string|-|-
...
. link:#++GET__config_transaction_full++[Retrieve the transaction configurations, changed since an optional specified time]
. link:#++POST__config_transaction_full++[Add or update the transaction configurations]
. link:#++DELETE__config_transaction_full__name_++[Remove the transaction configuration with the specified name]
. link:#++GET__config_transaction_full__name_++[Retrieve the transaction configuration for the specified name]
. link:#++PUT__config_transaction_full__name_++[Add or update the transaction configuration for the specified name]
. link:#++GET__config_transaction_summary++[Retrieve the transaction summaries]
. link:#++POST__config_transaction_validate++[Validate the transaction configuration]
...
[[GET__config_transaction_full]]
*Endpoint GET `/config/transaction/full`*

NOTE: *Retrieve the transaction configurations, changed since an optional specified time* +
...
[[POST__config_transaction_full]]
*Endpoint POST `/config/transaction/full`*

NOTE: *Add or update the transaction configurations* +
...
[[DELETE__config_transaction_full__name_]]
*Endpoint DELETE `/config/transaction/full/{name}`*

NOTE: *Remove the transaction configuration with the specified name* +
...
[[GET__config_transaction_full__name_]]
*Endpoint GET `/config/transaction/full/{name}`*

NOTE: *Retrieve the transaction configuration for the specified name* +
...
[[PUT__config_transaction_full__name_]]
*Endpoint PUT `/config/transaction/full/{name}`*

NOTE: *Add or update the transaction configuration for the specified name* +
...
[[GET__config_transaction_summary]]
*Endpoint GET `/config/transaction/summary`*

NOTE: *Retrieve the transaction summaries* +
...
[[POST__config_transaction_validate]]
*Endpoint POST `/config/transaction/validate`*

NOTE: *Validate the transaction configuration* +
