...
When the server is initially installed, then the default username and password is *_jdoe_* and *_password_*. When accessing the UI, you will be asked to enter the username and password.
